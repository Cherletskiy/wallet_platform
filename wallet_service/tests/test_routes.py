...
async def test_wallet_operation_invalid_amount(client, mock_wallet_repository):
    wallet_id = uuid.uuid4()
    response = await client.post(
        f"{base_url}/{wallet_id}/operation",
...
async def test_wallet_operation_invalid_amount_decimal_places(
    client,
...
async def test_wallet_operation_invalid_operation_type(client, mock_wallet_repository):
    wallet_id = uuid.uuid4()
    response = await client.post(
        f"{base_url}/{wallet_id}/operation",
